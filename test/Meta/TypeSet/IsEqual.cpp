...
#define CREATE_TEST_ASSERT(N) {\
	constexpr auto value = Meta::TypeSet::IsEqual<TypeParam::Set##N##1, TypeParam::Set##N##2>::value;\
...
namespace {
	...
	template<class T>
	class MetaTypeSetIsEqualTest : public testing::Test {
	};
...
// Define the tests
TYPED_TEST_CASE(MetaTypeSetIsEqualTest, Implementations);

TYPED_TEST(MetaTypeSetIsEqualTest, IsEqual) {
