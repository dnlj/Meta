...
#define CREATE_TEST_ASSERT(N) {\
	constexpr auto value = Meta::TypeSet::IsStrictSubset<TypeParam::Set##N##1, TypeParam::Set##N##2>::value;\
...
namespace {
	...
	template<class T>
	class MetaTypeSetIsStrictSubsetTest : public testing::Test {
	};
...
// Define the tests
TYPED_TEST_CASE(MetaTypeSetIsStrictSubsetTest, Implementations);

TYPED_TEST(MetaTypeSetIsStrictSubsetTest, IsStrictSubset) {
